...
void nineteen() {
	...
	int d;
	int n1, n2, n3;
	std::cout << "Введите 3х-значное число " << std::endl;
	std::cin >> a;
	...
	c = n1 * n2 * n3;
	if (c > b) {
		std::cout << "Произведение цифр больше числа b" << std::endl;
	}
	if (c < b) {
		std::cout << "Произведение цифр меньше числа b" << std::endl;
	}
	if (c ==b){
		std::cout << "Произведение цифр равно числу b" << std::endl;
	}
	d = n1 + n2 + n3;

	if (d % 7 == 0) {
		std::cout << "Сумма цифр числа делится без остатка на 7" << std::endl;

	}
	else {
		std::cout << "Сумма цифр числа без остатка на 7 не делится" << std::endl;
	}
